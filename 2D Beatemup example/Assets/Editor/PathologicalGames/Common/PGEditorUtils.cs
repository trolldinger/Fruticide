...
public static class PGEditorUtils 
{
    ...
    /// <param name="content">GUIContent object that allows for tool tips, etc</param>
    public static T ObjectField<T>(GUIContent content, T obj) where T : UnityEngine.Object
    {
        return ObjectField<T>(content, obj, true);
    }
    ...
    /// <param name="content">GUIContent object that allows for tool tips, etc</param>
    public static T ObjectField<T>(GUIContent content, T obj, bool allowSceneObjects)
            where T : UnityEngine.Object
    {
        return (T)EditorGUILayout.ObjectField(content, obj, typeof(T), allowSceneObjects);
    }
    ...
    /// <param name="content">GUIContent object that allows for tool tips, etc</param>
    public static T ObjectField<T>(GUIContent content, T obj, bool allowSceneObjects, GUILayoutOption[] options)
            where T : UnityEngine.Object
    {
        return (T)EditorGUILayout.ObjectField(content, obj, typeof(T), allowSceneObjects, options);
    }
    ...
    /// <param name="list">A generic List</param>
    /// <param name="expanded">A bool to determine the state of the primary fold-out</param>
    public static void FoldOutObjList<T>(string label, List<T> list, bool expanded) where T : UnityEngine.Object
    {
        // Store the previous indent and return the flow to it at the end
        int indent = EditorGUI.indentLevel;
        EditorGUI.indentLevel = 0;
        ...
        AddFoldOutListHeader<T>(label, list, expanded, indent );
    ...
    public static void FieldInfoField<T>(T instance, System.Reflection.FieldInfo fieldInfo)
    {
        ...
        if (fieldInfo.FieldType == typeof(string))
        {
            ...
            val = EditorGUILayout.TextField(content, val);
        ...
        else if (fieldInfo.FieldType == typeof(int))
        {
            ...
            val = EditorGUILayout.IntField(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        ...
        else if (fieldInfo.FieldType == typeof(GameObject))
        {
            ...
            val = ObjectField<GameObject>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(Transform))
        {
            ...
            val = ObjectField<Transform>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(Rigidbody))
        {
            ...
            val = ObjectField<Rigidbody>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(Renderer))
        {
            ...
            val = ObjectField<Renderer>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(Mesh))
        {
            ...
            val = ObjectField<Mesh>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        ...
        else if (fieldInfo.FieldType == typeof(BoxCollider))
        {
            ...
            val = ObjectField<BoxCollider>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(SphereCollider))
        {
            ...
            val = ObjectField<SphereCollider>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(CapsuleCollider))
        {
            ...
            val = ObjectField<CapsuleCollider>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(MeshCollider))
        {
            ...
            val = ObjectField<MeshCollider>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        else if (fieldInfo.FieldType == typeof(WheelCollider))
        {
            ...
            val = ObjectField<WheelCollider>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
        ...
        else if (fieldInfo.FieldType == typeof(CharacterController))
        {
            ...
            val = ObjectField<CharacterController>(content, val);
            fieldInfo.SetValue(instance, val);
            return;
        }
